program mvnormal_3rdlib_benchmark
  ...
  call build_problem(dimension, mean, covariance)
  allocate(output(dimension))

  call system_clock(count_rate=clock_rate)

  call system_clock(count=clock_start)
  call plan%init(mean, covariance)
  ...
  average_sample_seconds = total_sample_seconds / real(repeats, real64)

  write (output_unit, '(A,",", I0, ",", I0, ",", I0, ",", ES0.8, ",", &
       & ES0.8, ",", ES0.8, ",", ES0.17)') 'fortran-stdlib', dimension, &
       samples, repeats, setup_seconds, average_sample_seconds, &
...
end program mvnormal_3rdlib_benchmark
